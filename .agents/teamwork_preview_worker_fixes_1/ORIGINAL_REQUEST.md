...
Save your completion report containing the list of changes and build verification details to `handoff.md` inside your working directory `.agents/teamwork_preview_worker_fixes_1/`.
</USER_REQUEST>
