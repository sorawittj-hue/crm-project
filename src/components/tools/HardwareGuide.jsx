        ...
        <div className="lg:col-span-2 space-y-4">
          <div className="flex items-center gap-3 mb-4 md:mb-6">
            <div className={cn(
              ...
              <currentCategoryDb.icon size={20} md:size={24} strokeWidth={2.5} />
            </div>
            <div>
                ...
                >
                  <div className="flex items-start gap-3 md:gap-4 font-inter">
                    <div className={cn(
                      ...
                      <ProfileIcon size={18} md:size={20} strokeWidth={2.5} />
                    </div>
              ...
              <div className={cn(
                ...
                <div className="flex flex-col md:flex-row items-start gap-4 md:gap-6">
                  <div className={cn(
                    ...
                    <currentCategoryDb.icon size={30} md:size={36} strokeWidth={2} />
                  </div>
              ...
              <div className="p-6 md:p-10">
                ...
                >
                  <div className="w-8 h-8 md:w-10 md:h-10 rounded-xl bg-white flex items-center justify-center shrink-0">
                    <Shield size={16} md:size={18} className="text-slate-400" />
                  </div>
                  <div>
