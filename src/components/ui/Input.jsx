    ...
    <div className="relative w-full">
      ...
      <div className="relative group">
        ...
        <input
          type={type}
          className={cn(
            "flex h-11 w-full rounded-xl border bg-slate-50/80 px-4 py-2.5 text-sm font-medium text-slate-800",
            ...
            "focus-visible:border-indigo-400 focus-visible:bg-white",
